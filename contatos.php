                ...
                <div class="header-top">
                    <div class="container">
                        <div class="row">
                                        ...
                                        <div id="sub-cart" class="sub-header">
                                            ...
                                            <div class="cart-footer">
                                                <div class="text-right">
                                                    <a href="orcamento.html" class="btn btn-default btn-round view-cart">ver or&ccedil;amento</a>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- // SHOPPING CART -->
                            ...
                            <a href="login.php"><button type="button" class="btn btn-danger"><img src="img/ico-login.png" style="margin-top:-3px; margin-right:5px;">ADM</button></a>

                            <a href="login.php"><button type="button" class="btn btn-warning"><img src="img/ico-login.png" style="margin-top:-3px; margin-right:5px;">acompanhe sua obra</button></a>
                    ...
                    <div class="row">
                        ...
                        <section class="section">
                            <section class="col-xs-12 col-sm-8 col-md-9">
                                ...
                                <h3 class="uppercase text-bold"><span class="text-xs">Mande uma mensagem direta</span></h3>
                                <div class="row">
                                    <div id="frm-contact-us">
                                        <form action="php/enviar_email.php" method="POST" id="contact-form" class="clearfix" role="form">
                                            <div class="col-xs-12 col-sm-12 col-md-5">
                                                <div class="form-group stylish-input">
                                                    <label for="contactName" class="required">Nome Empresa</label>
                                                    <input type="text" class="form-control" id="contactName" name="nome" data-validate="^[?-?\w\s]{2,30}$" require />
                                                </div>
                                                <div class="form-group stylish-input">
                                                ...
                                                <div class="form-group stylish-input">
                                                    ...
                                                    <input type="text" class="form-control" name="assunto" id="contactSubject" />
                                                </div>
                                            </div>
                                            <div class="space10 visible-xs visible-sm"></div>
                                            <div class="col-xs-12 col-sm-12 col-md-7">
                                                <div class="form-group stylish-input">
                                                    <label for="contactMSG" class="required">Mensagem</label>
                                                    <textarea id="contactMSG" class="form-control" name="mensagem" style="height: 178px;" data-validate=".{2,400}$" required></textarea>
                                                </div>
                                            </div>
                                            <div class="space10"></div>
                                            <div class="col-xs-12 col-sm-12">
                                                <button class="btn btn-default btn-round pull-right">Enviar</button>
                                            </div>
                                        </form>
                                        ...
                                        <div class="alert alert-success" id="contact_success" style="display: none;">
                                            ...
                                            <div class="alert-inner">
                                                <strong>Obrigado,</strong> sua mensagem foi enviada com sucesso. Retornaremos o mais breve possível.
                                            </div>
                                        </div>
                                        <!-- /success msg -->
                                        ...
                                        <div class="alert alert-danger" id="contact_fail" style="display: none;">
                                            <button type="button" class="close" data-dismiss="alert">&times;</button>
                                            <div class="alert-inner">
                                                <strong>Desculpe,</strong> tente novamente.
                                            </div>
                                        </div>
                                        <!-- /error msg -->
                                        <!-- /CONTACT FORM ALERTS -->
                            ...
                            <aside class="col-xs-12 col-sm-4 col-md-3">
                                ...
                                <section class="sidebar">
                                    ...
                                    <section class="side-section">
                                        <h3 class="uppercase text-bold"><span class="text-xs">CONTATOS</span></h3>
                                        <div class="light-color text-xs">
                                            <ul class="menu iconed-list unstyled">
                                                <li>
                                                    <span class="list-icon"><i class="round-icon text-sm iconfont-map-marker"></i></span>
                                                    <div class="list-content">AV. buriti, 5800 ? Distrito Industrial ? Manaus ? Amazoans</div>
                                                </li>
                                                <li>
                                                    <span class="list-icon"><i class="round-icon text-sm iconfont-phone"></i></span>
                                                    <div class="list-content">(+55) 92 3615 1000</div>
                                                </li>
                                                <li>
                                                    <span class="list-icon"><i class="round-icon text-sm iconfont-envelope-alt"></i></span>
                                                    <div class="list-content">contato@fergel.com.br</div>
                                                </li>
                                                <li>
                                                    <span class="list-icon"><i class="round-icon text-sm iconfont-envelope-alt"></i></span>
                                                    <div class="list-content">vendas@fergel.com.br</div>
                                                </li>
                                            </ul>
                                        </div>
                                    </section>
