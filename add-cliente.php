                ...
                <div class="container">
                    <div class="relative">
                        <ul class="bc unstyled clearfix">
                            ...
                            <li class="active">Inclus&atilde;o de clientes</li>
                        </ul>
                    </div>
                </div>
            </div>
                            ...
                            <div class="sidebar">
                                <nav class="nav-side side-section">
                                    <ul class="nav nav-tabs nav-stacked">
                                        ...
                                        <li><a style="color:#921812;" href="#">Adicionar cliente</a></li>
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div id="checkout-collapse2" class="panel-collapse">
                                        <div class="panel-body">
                                            <form  class="form-horizontal" method="POST" role="form" action="php/salvar_clientes.php">
                                                <div class="row">
                                                    <div class="col-xs-12 col-sm-12 col-md-6">
                                                        <div class="form-group stylish-input">
                                                            <label for="inputFirstname" class="col-sm-4 col-lg-4 control-label required">RAZ&Atilde;O SOCIAL</label>
                                                            <div class="col-sm-8 col-lg-8">
                                                                <input type="text" class="form-control" id="inputFirstname" required name="razaosocial" />
                                                            </div>
                                                        </div>
                                                        <div class="form-group stylish-input">
                                                            <label for="inputLastname" class="col-sm-4 col-lg-4 control-label required">CNPJ</label>
                                                            <div class="col-sm-8 col-lg-8">
                                                                <input type="text" class="form-control" id="inputLastname" required name="cnpj" />
                                                            </div>
                                                        </div>
                                                        <div class="form-group stylish-input">
                                                            <label for="inputEmail2" class="col-sm-4 col-lg-4 control-label required">E-Mail</label>
                                                            <div class="col-sm-8 col-lg-8">
                                                                <input type="email" class="form-control" id="inputEmail2" required name="email" />
                                                            </div>
                                                        </div>
                                                        <div class="form-group stylish-input">
                                                            <label for="inputPhone" class="col-sm-4 col-lg-4 control-label required">TELEFONE</label>
                                                            <div class="col-sm-8 col-lg-8">
                                                                <input type="text" class="form-control" id="inputPhone" required name="telefone"/>
                                                            </div>
                                                        </div>
                                                        <div class="form-group stylish-input">
                                                            <label for="inputCompany" class="col-sm-4 col-lg-4 control-label">CONTATO</label>
                                                            <div class="col-sm-8 col-lg-8">
                                                                <input type="text" class="form-control" id="inputCompany" required name="contato"/>
                                                            </div>
                                                        </div>
                                                        <div class="form-group stylish-input">
                                                            <label for="inputCompany" class="col-sm-4 col-lg-4 control-label">LOGIN</label>
                                                            <div class="col-sm-8 col-lg-8">
                                                                <input type="text"  class="form-control" id="inputCompany" required name="login"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-xs-12 col-sm-12 col-md-6">
                                                        <div class="form-group stylish-input">
                                                            ...
                                                            <div class="col-sm-8 col-lg-8">
                                                                <input type="text" class="form-control" id="inputAddress1" required name="endereco" />
                                                            </div>
                                                        </div>
                                                        <div class="form-group stylish-input">
                                                            <label for="inputCity" class="col-sm-4 col-lg-4 control-label required">BAIRRO</label>
                                                            <div class="col-sm-8 col-lg-8">
                                                                <input type="text" class="form-control" id="inputCity" required name="bairro"/>
                                                            </div>
                                                        </div>
                                                        <div class="form-group stylish-input">
                                                            <label for="inputPostcode" class="col-sm-4 col-lg-4 control-label required">CEP</label>
                                                            <div class="col-sm-8 col-lg-8">
                                                                <input type="text" class="form-control" id="inputPostcode" required name="cep" />
                                                            </div>
                                                        </div>
                                                        <?php
                                                        ...
                                                        <div class="form-group stylish-input">
                                                            ...
                                                            <div class="col-sm-8 col-lg-8">
                                                                <select name="estados"  required="estados" class="form-control" id="inputState">
                                                                    ...
                                                                    <?php while ($row_estado = mysql_fetch_array($sql_executa_estados)) {
                                                                        ?>
                                                        ...
                                                        <div class="form-group stylish-input">
                                                            ...
                                                            <div class="col-sm-8 col-lg-8">
                                                                <input type="password" class="form-control" id="inputCompany" required name="senha"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
