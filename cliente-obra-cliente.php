                ...
                <div class="header-top">
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            </div><!-- // "col-xs-12 col-sm-6 col-md-2" -->

                            <a href="login_adm.php">
                                <button type="button" class="btn btn-danger">
                                    <img src="img/ico-login.png" style="margin-top:-3px; margin-right:5px;"> ADM
                                </button>
                            </a>

                            <a href="login_cliente.php">
                                <button type="button" class="btn btn-warning">
                                    <img src="img/ico-login.png" style="margin-top:-3px; margin-right:5px;"> acompanhe sua obra
                                </button>
                            </a>
                                    ...
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
                                            <a data-toggle="collapse" data-parent="#checkout-collapse" href="#checkout-collapse1">
                                                INFORMA&Ccedil;&Otilde;ES SOBRE A OBRA DE:<h4 style="color:#C00; font-family: Raleway;"> <?php echo $decodificar_cliente; ?></h4>
                                            </a>
                                        </h4>
                                    </div>
                                                ...
                                                <div class="col-xs-12 col-sm-6">
                                                    ...
                                                    <div class="inner">
                                                        ...
                                                        <div class="form-group stylish-input">
                                                            <div class="col-sm-8 col-lg-12" style="padding-left:1px;">
                                                                <h50>ENDERE�O</h50> 
                                                                <p><?php echo $row_obra['endereco_obra']; ?></p>
                                                            </div>
                                                        </div>
                                    ...
                                    <div id="checkout-collapse4" class="panel-collapse collapse">
                                        <div class="panel-body">
                                            ...
                                            <section class="products-wrapper" style="margin-top:80px; font-family: Raleway;">
                                                ...
                                                <?php
                                                $idaarquivo = $_GET['id'];
                                                $sql_arquivo = "SELECT * FROM arquivos WHERE id_obra = $idaarquivo";
                                                $executa_arquivo = mysql_query($sql_arquivo);

                                                while ($row_arquivo = mysql_fetch_array($executa_arquivo)) {
                                                    ?>
                                                    <!-- ARQUIVO -->
                                                    <div class="products-layout">
                                                        <div class="product" style="max-width:247px;">
                                                            <div class="entry-main">
                                                                <h5 class="entry-title">
                                                                    <a href="php/fotos/<?php echo $row_arquivo['arquivo']; ?>" style="font-size:12px; font-weight:600;"><?php echo $row_arquivo['nome']; ?></a>
    <!--                                                                    <hr/><a style="font-size:9px;"href="php/excluir_arquivo.php?arquivo=<?php echo $row_arquivo['id_arquivos']; ?>&idobra=<?php echo $_GET['id'] ?>"><img style="margin-right:5px;"src="img/ico-delete.png" width="15">excuir</a>-->
