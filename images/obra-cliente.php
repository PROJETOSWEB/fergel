                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xs-12 col-sm-6">
                                                    ...
                                                    <div class="inner">
                                                       ...
                                                       <!-- ESPAÇO --> <div class="space20 clearfix"></div> <!-- ESPAÇO -->
                                                       ...
                                                       <!-- ESPAÇO --> <div class="space20 clearfix"></div><!-- ESPAÇO -->
                                                		...
                                                		<!-- ESPAÇO --><div class="space40 visible-xs"></div> <!-- ESPAÇO -->
                                            ...
                                            <section class="products-wrapper" style="margin-top:80px; font-family: Raleway;">
                                                ...
                                                <div class="products-layout">
                                                    <div class="product" style="max-width:247px;">
                                                        <div class="entry-main">
                                                            <h5 class="entry-title">
                                                                <a href="#" style="font-size:12px; font-weight:600;">Título do arquivo • PDF</a>
                                                            </h5>
                                                        </div>
                                                    </div>
                                                </div>
