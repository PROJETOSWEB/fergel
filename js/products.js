	...
	*/
	function output_cookie()
	{
		...
		for ( var x in cookie )
		{
			...
			var $new = $('<tr> \
							<td> \
								<a class="entry-title" style="font-weight:600;"><input name="produto[]" value="'+ cookie[x].title +'" style="border: none; width: 350px;" /></a> \
							</td> \
							<td class="hidden-xs"><strong  class="text-bold row-total"></strong></td> \
							<td><input name"especificao[]" value="' + cookie[x].desc + '" style="border: none; width: 150px;" /></td> \
							<td><input name="preco[]" value="' + cookie[x].price + '" style="border: none; width: 250px;" /></td> \
							<td> \
								<div class="qty-btn-group"> \
									<input name="quantidade[]" value="' + cookie[x].qty + '" /> \
								</div> \
							</td> \
							<td class="hidden-xs" style="margin-left:30px;"><button type="button" class="close" aria-hidden="true"><img src="img/ico-delete.png" width="100%"></button></td> \
						</tr>');
