                                            ...
                                            <div class="row">
                                                <div class="col-xs-11 col-sm-11 col-md-5" style="margin-left:30px;">
                                                    <div class="form-group stylish-input">
                                                        ...
                                                        <textarea name="avisos" id="contactMSG" class="form-control" name="message" style="height: 178px;" data-validate=".{2,400}$" required></textarea>
                                                    </div>
                                                </div>
                                                <div class="col-xs-11 col-sm-11 col-md-6" style="margin-left:10px;">
                                                    <div class="form-group stylish-input">
                                                        ...
                                                        <textarea name="observacoes" id="contactMSG" class="form-control" name="message" style="height: 178px;" data-validate=".{2,400}$" required></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="space20 clearfix"></div>
                                            ...
                                            <section class="products-wrapper" style="margin-top:80px;">
                                                ...
                                                <div class="row">
                                                    <div class="form-group stylish-input">
                                                        ...
                                                        <input name="foto1" type="file" name="fotopng" class="default" />
                                                        <label for="inputEmail" class="col-xs-12 col-sm-3 control-label">legenda</label>
                                                        <div class="col-lg-7">
                                                    ...
                                                    <div class="form-group stylish-input">
                                                        ...
                                                        <input name="foto2" type="file" name="fotopng" class="default" />
                                                        <label for="inputEmail" class="col-xs-12 col-sm-3 control-label">legenda</label>
                                                        <div class="col-lg-7">
                                                    ...
                                                    <div class="form-group stylish-input">
                                                        ...
                                                        <input name="foto3" type="file" name="fotopng" class="default" />
                                                        <label for="inputEmail" class="col-xs-6 col-sm-3 control-label">legenda</label>
                                                        <div class="col-lg-7">
                                                    ...
                                                    <div class="form-group stylish-input">
                                                        ...
                                                        <input name="foto4" type="file" name="fotopng" class="default" />
                                                        <label for="inputEmail" class="col-xs-6 col-sm-3 control-label">legenda</label>
                                                        <div class="col-lg-7">
