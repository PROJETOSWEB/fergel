                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-6 col-md-7">
                                ...
                                <div class="contact-info">
                                    ...
                                    <span>Av. Buriti, 500 &bull; Distrito &bull; Manaus &bull; Amazonas &bull; Brasil</span>
                                </div>
                                <!-- // CONTACT INFO -->
                            </div>
                                    ...
                                    <li data-toggle="sub-header" data-target="#sub-cart" style="float:rigth;">
                                        ...
                                        <div id="sub-cart" class="sub-header">
                                            <div class="cart-header">
                                                <span>Vocï¿½ nï¿½o tem itens no seu orï¿½amento.</span>
                                                <small><a href="cart.html">ï¿½ ver tudo ï¿½</a></small>
                                            </div>
                                            <ul class="cart-items product-medialist unstyled clearfix"></ul>
                                            <div class="cart-footer">
                                                <div class="text-right">
                                                    <a href="cart.html" class="btn btn-default btn-round view-cart">ver orï¿½amento</a>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- // SHOPPING CART -->
                            ...
                            <div class="sidebar">
                                <nav class="nav-side side-section">
                                    <ul class="nav nav-tabs nav-stacked">
                                        ...
                                        <li><a style="color:#921812;" href="#">LISTA DE OBRAS</a></li>
                                    </ul>
                                </nav>
                            </div>
                        </aside>
                                            ...
                                            <div class="row">
                                                ...
                                                <table class="shop-summary">
                                                    ...
                                                    while ($row = mysql_fetch_array($executa_sql_obra)) {
                                                        ...
                                                        <tr class="tabela">
                                                            <td><a href="obra-cliente.php?cliente=<?php echo $cliente; ?>&id=<?php echo $row['id_obra']; ?>">OBRA <?php echo $row['id_obra']; ?> ï¿½ <?php echo $row['obra']; ?></a></td>
                                                            <td><a href="edit-obra.php?id=<?php echo $row['id_obra']?>">Edit</a></td>
                                                        </tr>
                                                        <?php
                                                    }
                                                    ?>
