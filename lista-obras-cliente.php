                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
                                            listagem de obras de: <b style="color:#921812; font-family: Raleway;"> <?php echo $linha_co['razao_social']; ?></b>
                                        </h4>
                                    </div>
                                    <div id="checkout-collapse6" class="panel-collapse">
                                        <div class="panel-body">
                                            <div class="row">
                                                <?php
                                                $obraid = $_GET['id'];
                                                $sql_obra = "SELECT * FROM obra where id_clientes = $obraid";
                                                ...
                                                <table class="shop-summary">
                                                    ...
                                                    while ($row = mysql_fetch_array($executa_sql_obra)) {
                                                        ...
                                                        <tr class="tabela">
                                                            <td><a style="margin-right: 35px;" href="obra-cliente.php?cliente=<?php echo $idc; ?>&id=<?php echo $_GET['idc']; ?>"><?php echo $row['obra']; ?></a></td>
