                                    ...
                                    <div id="checkout-collapse6" class="panel-collapse">
                                        <div class="panel-body">
                                            <div class="row">
                                                ...
                                                $sql_obra = "SELECT * FROM obra WHERE id_clientes = $cliente";
                                                ...
                                                <table class="shop-summary">
                                                    ...
                                                    while ($row = mysql_fetch_array($executa_sql_obra)) {
                                                        ...
                                                        <tr class="tabela">
                                                            <td><a href="cliente-obra-cliente.php?cliente=<?php echo $cliente; ?>&id=<?php echo $row['id_obra']; ?>"> <?php echo $row['id_obra']; ?> • <?php echo $row['obra']; ?></a></td>
